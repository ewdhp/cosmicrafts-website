...
const linkMap = {
  '/marketing': [
    ...
    { name: 'Top 10 weekly', path: '/marketing/promos/top10_weekly' },
    { name: 'Tier Levels', path: '/marketing/promos/tiers' },
    { name: 'Limited-time Deals', path: '/marketing/promos/deals' },
    { name: 'Exclusive Offers', path: '/marketing/promos/exclusive' },
  ],
};
...
<template>
  ...
  <div style="display:flex; flex-direction: row; ">
    ...
    <div class="left-nav">
      <SLinkList :items="items" :title="title" />
    </div>
